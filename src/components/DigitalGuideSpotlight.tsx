          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center pt-8">
            ...
            <div className="lg:col-span-7 space-y-6">
              <div>
                ...
                <h2 className="text-3xl sm:text-4xl lg:text-5xl font-black uppercase text-white tracking-tight font-display leading-[1.05]">
              ...
              {/* Price and Gumroad Action */}
              <div className="pt-4 flex flex-col sm:flex-row items-stretch sm:items-center gap-4">
                <div className="p-3.5 rounded-xl bg-black border border-zinc-800 text-center sm:text-left">
                ...
                <div className="flex-1 flex flex-col sm:flex-row gap-2.5">
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="flex-1 py-4 px-6 rounded-xl font-black text-xs sm:text-sm uppercase tracking-wider bg-[#ccff00] text-black hover:bg-[#b3e600] transition flex items-center justify-center gap-2 shadow-lg shadow-[#ccff00]/25"
                  >
                  ...
                  <Link
                    href="/utmutato"
                    className="py-4 px-5 rounded-xl font-black text-xs uppercase tracking-wider bg-zinc-900 border border-zinc-700 text-white hover:border-[#ccff00] hover:text-[#ccff00] transition flex items-center justify-center gap-1.5"
                  >
                    <span>Részletek</span>
            ...
            <div className="lg:col-span-5 relative flex justify-center">
              <div className="relative w-full max-w-sm aspect-[4/5] rounded-2xl bg-gradient-to-b from-zinc-800 to-black p-4 border border-[#ccff00]/30 shadow-2xl overflow-hidden group">
                <div className="relative w-full h-full rounded-xl overflow-hidden">
                  ...
                  <div className="absolute inset-x-4 bottom-4 space-y-2">
                    <span className="text-[10px] font-black uppercase px-2 py-0.5 rounded bg-[#ccff00] text-black">
                      E-BOOK & DOKUMENTÁCIÓ
                    </span>
                    ...
                    <p className="text-[11px] text-zinc-300">
                      PDF letöltés + Frissülő Notion adatbázis hozzáférés
                    </p>
                  </div>
                </div>
              </div>
