  ...
  return (
    ...
    >
      ...
      <div className="p-3.5 sm:p-4 flex-1 flex flex-col justify-between">
        <div>
          <div className="flex items-center gap-1.5 text-[11px] font-medium text-zinc-400 font-sans">
            <span className="text-[#ccff00] font-semibold">{product.brand}</span>
            {product.subCategory && <span>• {product.subCategory}</span>}
          </div>

          <h3 className="text-xs sm:text-sm font-medium text-white line-clamp-2 mt-1 group-hover:text-[#ccff00] transition font-nekst normal-case">
            {product.name}
          </h3>
        </div>
